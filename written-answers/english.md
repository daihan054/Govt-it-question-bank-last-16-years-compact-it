...
1. Focus Writing in English: "The Role of Sustainable Banking in Achieving the UN Sustainable Development Goals (SDGs) in Bangladesh." *[Officer (IT) 31 Jul 2026 bscs 01 (ET: N/A)]*
   ...
   Answer: The Role of Sustainable Banking in Achieving the UN Sustainable Development Goals (SDGs) in Bangladesh

   Sustainable banking means directing credit and investment towards activities that protect the environment, promote social equity and remain financially sound. For Bangladesh, a country ranked among the most climate-vulnerable in the world, it is not an option but a necessity.

   Bangladesh Bank has been a pioneer in this field. Its Green Banking Policy, the Sustainable Finance Department, the Green Transformation Fund and the mandatory sustainability rating of banks have pushed the whole sector towards responsible lending. Banks now finance solar home systems, effluent treatment plants, green factories and energy-efficient brick kilns.

   The contribution to the SDGs is direct. Refinancing schemes for small entrepreneurs and women-led enterprises support SDG 1 and SDG 5. Agent banking and mobile financial services have brought millions of unbanked people into the formal system, advancing SDG 8 and SDG 10. Renewable energy financing serves SDG 7, and green industrial lending serves SDG 13. Bangladesh now has the largest number of LEED-certified green garment factories in the world, financed largely through this framework.

   Challenges remain: greenwashing, weak monitoring, limited technical capacity to appraise green projects and the higher cost of long-term finance. Stronger disclosure rules, trained assessors and concessional refinancing can overcome them.

   Sustainable banking turns the financial sector into an instrument of national development rather than a mere lender.
...
*[Introduction- Concept of Digital citizenship- Benefits of social media- Challenges and risks- Online ethics and responsible behavior- Combating fake news and misinformation- Role of digital literacy and awareness- Conclusion]*
   ...
   Answer: Digital Citizenship on Social Media

   Introduction: Social media has become the public square of the twenty-first century. Digital citizenship is the set of norms that governs how a person should behave in that space.

   Concept of digital citizenship: A digital citizen is one who uses technology safely, legally, ethically and responsibly. It covers digital access, digital literacy, digital etiquette, digital rights and duties, digital security and digital wellbeing.

   Benefits of social media: It gives instant communication across distance, a free platform for expression, learning resources, business opportunities for small entrepreneurs, rapid disaster response, and a voice to communities that traditional media ignore.

   Challenges and risks: Cyberbullying, identity theft, phishing, privacy violation, doxxing, addiction, mental health damage from constant comparison, and the rapid spread of rumours that have caused mob violence in our own country.

   Online ethics and responsible behaviour: Respect others as you would face to face, verify before sharing, credit original creators, avoid hate speech, protect your passwords, and remember that the digital footprint is permanent.

   Combating fake news and misinformation: Check the source, look for the original report, use fact-checking services, do not forward unverified messages, and report false content instead of arguing with it.

   Role of digital literacy and awareness: Digital literacy must be taught in schools, in workplaces and through public campaigns, so that users can evaluate information critically rather than react emotionally.

   Conclusion: Technology itself is neutral. Responsible digital citizenship is what turns social media from a source of division into a tool of progress.
3. **(e) Write a short paragraph arguing for or against the statement "AI will eventually replace human workers in most professions."** *[NPCBL Sub Assistant Engineer: Cyber Security Analyst Date: 11 July 2026 (ET: N/A)]*
   ...
   Answer: Against the statement: AI will not replace human workers in most professions.

   Artificial intelligence is transforming work, but the claim that it will replace humans in most professions overstates what the technology actually does. AI is a pattern-matching tool. It is superb at repetitive, data-heavy and rule-bound tasks, and weak wherever judgement, empathy, physical dexterity or accountability is required.

   History supports this. The automated teller machine was expected to end the career of the bank teller, yet the number of tellers rose for two decades because branches became cheaper to run and multiplied. Spreadsheets did not end accountancy; they moved accountants from arithmetic to analysis. Technology has consistently shifted the content of jobs rather than removing them.

   Most professions are bundles of tasks, not single tasks. A doctor reads scans, but also examines patients, weighs uncertain evidence, explains bad news and bears legal responsibility. AI can take over the first task and leave the rest untouched. The same applies to teachers, lawyers, engineers and nurses.

   The real risk is not mass unemployment but polarisation. Routine clerical and data-entry roles will shrink sharply, and those workers need retraining, not reassurance.

   The rational conclusion is that AI will replace tasks, augment workers and create new occupations, provided governments invest seriously in reskilling.
4. **Paragraph on: Three Zero theory** *[BREB Assistant Programmer (AP) 21.02.2025 compact it 1336 (ET: N/A)]*


   Answer: The Three Zero Theory

   The Three Zero theory was proposed by Nobel laureate Professor Muhammad Yunus. It sets out a vision of a civilisation built on three targets: zero poverty, zero unemployment and zero net carbon emission.

   Zero poverty means that poverty is not created by poor people but by the economic system around them. If credit, skills and markets reach everyone, no one need remain poor. Microcredit, which reached millions of rural women in Bangladesh, was the first practical test of this idea.

   Zero unemployment rests on the belief that every human being is born an entrepreneur, not a job seeker. Instead of waiting for employers, young people should be supported with seed capital, mentoring and social business funds so that they create jobs for themselves and others.

   Zero net carbon emission demands that consumption and production stop damaging the planet. Renewable energy, recycling and responsible consumption are essential, because the poorest countries, including Bangladesh, suffer most from a crisis they did not cause.

   The instrument for achieving all three is the social business: a company that is financially self-sustaining but returns no dividend, reinvesting all profit in its social mission.

   For a young and densely populated country like Bangladesh, the Three Zero theory offers a practical roadmap in which growth, employment and environmental protection advance together rather than against one another.
5. **Write an essay on "Corruption in the ICT Sector in Bangladesh" using the hints given below: [Hints: Introduction- Types of corruption- Causes of corruption- Effects of corruption-Remedies- Conclusion]** *[BPSC (Ministry of Power, Energy & Mineral Resources) Assistant Director (ICT) (CS/CSE) 29.05.2025 compact it 1357 (ET: N/A)]*
   ...
   Answer: Corruption in the ICT Sector in Bangladesh

   Introduction: The ICT sector is the engine of the Digital Bangladesh programme, but it has not escaped the corruption that weakens other public services. Because ICT projects involve large budgets and highly technical specifications, they are unusually easy to manipulate.

   Types of corruption: Tender manipulation and collusive bidding; specifications written around one brand so that only one supplier qualifies; over-invoicing of hardware and software licences; ghost projects that exist only on paper; bribery for licences, domain approvals and connectivity permissions; recruitment irregularities in technical posts; and misuse of public data for private gain.

   Causes of corruption: Weak monitoring by non-technical supervisors, lack of transparency in procurement, absence of an independent technical audit, political influence, low accountability, poor salary structure at the lower level, and the sheer complexity of ICT products, which makes overpricing hard to detect.

   Effects of corruption: Public money is wasted, systems are delivered late or never, the quality of equipment is poor, citizens lose trust in digital services, capable local firms are pushed out, cyber security suffers because substandard products are installed, and foreign investors hesitate.

   Remedies: Full e-GP with published evaluation reports, independent technical committees, open-source and open-standard preference to prevent vendor lock-in, third-party audit of every large project, protection for whistle-blowers, digital tracking of every payment, and strict enforcement by the Anti-Corruption Commission.

   Conclusion: Digital technology is itself one of the strongest weapons against corruption. Using it honestly within the ICT sector is the first test of the sector's own credibility.
6. **Write an essay on 'The Internet' using the hints given below:** *[BPSC (Ministry of Food) Network/Website Manager (ICT) 21.05.2025 compact it 1348 (ET: N/A)]*
   *[Hints: What internet is- Great Communication tool-Various uses-Storehouse of information-Impact of the internet on our daily life- Social impact- Changing life- Uses and abuses- Conclusion.]*
   ...
   What the internet is: The internet is a global network of interconnected computer networks that communicate through a common set of protocols, mainly TCP/IP. Beginning as the ARPANET research project in 1969, it now links billions of devices in every country.

   A great communication tool: E-mail, instant messaging, voice and video calls, and social platforms have made distance almost irrelevant. A family separated by continents can speak daily at almost no cost.

   Various uses: Education through online courses and digital libraries; commerce through e-commerce and mobile banking; governance through e-GP, online passport and NID services; health through telemedicine; and entertainment through streaming media.

   A storehouse of information: Search engines, encyclopaedias, research repositories and open datasets have placed the accumulated knowledge of humanity within reach of anyone with a connection.

   Impact on daily life: Bills are paid online, tickets are booked online, remittances arrive within minutes, and freelancers in small towns earn foreign currency from home.

   Social impact: It has given ordinary citizens a voice, strengthened civic movements and connected diaspora communities, but it has also weakened face-to-face relationships and shortened attention spans.

   Changing life: Work from home, digital classrooms and cashless payment, all accelerated by the pandemic, show how quickly the internet reshapes society.

   Uses and abuses: Against its benefits stand cybercrime, fraud, pornography, rumour, addiction and privacy violation.

   Conclusion: The internet is a powerful servant and a dangerous master. Digital literacy and self-discipline decide which one it becomes.
7. **Write short note on:** "The role of AI and machine language mitigate challenges of cyber attack on banking system" 100 to 150 Words. *[Bangladesh Bank Assistant Director (ICT) 07.02.2025 compact it 1324 (ET: DU)]*
   ...
   Answer: The Role of AI and Machine Learning in Mitigating Cyber Attacks on the Banking System

   Banks are among the most attacked institutions in the world, and the volume of transactions has grown far beyond what human analysts can monitor. Artificial intelligence and machine learning have therefore become essential to banking security.

   Their first strength is anomaly detection. A model learns the normal behaviour of each customer, such as usual amounts, locations, devices and times, and flags any transaction that deviates from that baseline. This catches card fraud and account takeover within milliseconds, before the money leaves the system.

   Their second strength is speed and scale. Machine learning engines examine millions of log entries, network flows and ATM events in real time, identifying phishing sites, malware traffic and insider misuse that signature-based tools would miss.

   They also support behavioural biometrics, adaptive authentication, automated incident response and the prediction of new attack patterns from global threat intelligence.

   The limits must be acknowledged. Models produce false positives, they can be poisoned with bad training data, attackers now use AI themselves, and explainability is required by regulators.

   Used with skilled human oversight, AI and machine learning shift bank security from reacting after a loss to preventing it.
8. **Roadside tree plantation in reducing noise pollution.** *[Sonali Bank PLC Assistant Database Administrator 23.02.2024 compact it 312 (ET: N/A)]*
   ...
   Answer: Roadside Tree Plantation in Reducing Noise Pollution

   Noise pollution has become a serious health hazard in Bangladeshi cities. Dhaka regularly records 90 to 100 decibels on its main roads, far above the 60 decibel limit set for a commercial area. Constant exposure causes hearing loss, high blood pressure, sleeplessness, irritability and poor concentration in students.

   Roadside tree plantation is one of the simplest and cheapest defences. A well-designed belt of trees works in three ways. The leaves and branches absorb sound energy, especially at the higher frequencies that the ear finds most irritating. The rough surfaces of trunks and foliage scatter sound waves so that they lose energy in many directions. The soft ground and undergrowth beneath the trees absorb the ground-borne component instead of reflecting it as concrete does.

   Research shows that a dense green belt of about ten metres depth can reduce noise by five to ten decibels, which the ear perceives as roughly halving the loudness. Evergreen species with broad, thick leaves and dense branching close to the ground, planted in staggered rows, give the best result.

   The additional benefits are considerable: shade, dust filtration, carbon absorption, lower urban temperature and a more pleasant streetscape.

   City corporations should therefore treat roadside plantation as essential infrastructure rather than decoration.
9. **Write an essay on 'Modern Technology and Its Effect on Student Academic Achievements' within 150 (+/- 10% ) words.** *[Combined Bank Senior Officer (IT) 17.05.2024 compact it 322 (ET: BIBM)]*
   ...
   Answer: Modern Technology and Its Effect on Student Academic Achievements

   Modern technology has changed how students learn more profoundly than any reform of the last century. Laptops, smartphones, projectors and reliable internet have brought the classroom and the library together on a single screen.

   The benefits are clear. Students reach research papers, video lectures and open courseware that no local library could hold. Simulations make abstract ideas in physics, chemistry and mathematics visible. Learning management systems allow a lesson to be replayed until it is understood, which helps slower learners most. Online assessment gives instant feedback, and collaboration tools let students work together across distance.

   The risks are equally real. The same device that delivers a lecture also delivers social media and games. Studies link heavy unstructured screen time with shorter attention spans, poorer sleep and weaker writing skills. Easy copying and, more recently, uncritical use of AI tools encourage plagiarism instead of thinking. The digital divide widens the gap between urban and rural students.

   Evidence suggests that technology raises achievement when it is guided by a trained teacher and lowers it when it merely replaces one. The device is a tool, not a teacher.

   Balanced, supervised and purposeful use is therefore the condition on which the academic benefit depends.
10. **Write a short composition "The Role of computer on education system in Bangladesh".** *[Combined Bank Assistant Programmer 09.02.2024 compact it 299 (ET: BIBM)]*
    ...
    Answer: The Role of the Computer in the Education System of Bangladesh

    The computer has moved from being a subject of study in Bangladesh to being the medium through which every other subject is taught. Since the Digital Bangladesh programme began in 2009, the change has reached even remote upazila schools.

    Its contribution appears at several levels. Multimedia classrooms, now numbering in the tens of thousands, turn a textbook chapter into an illustrated and animated lesson. The Shikkhok Batayon portal lets a teacher in Rangpur use content prepared by a colleague in Chattogram. Muktopaath and various online platforms offer free professional training. During the COVID-19 closure, computers and the internet kept education alive through online classes and televised lessons.

    Administration has benefited just as much. Result processing, MPO management, student databases, online admission and public examination registration are now handled digitally, which has reduced delay and manipulation.

    Serious obstacles remain: an unequal supply of devices, weak electricity and broadband in rural areas, insufficient teacher training, a shortage of quality Bangla-language content, and inadequate maintenance of the equipment already installed.

    If the government continues to invest in teacher capacity and rural connectivity rather than in hardware alone, the computer can equalise educational opportunity across the whole country.
11. **Focus in English: “Impacts of air pollution on human health” within 150 (+-10%) word.** *[Combined Bank Assistant Maintenance Engineer/ Assistant Engineer (IT) 24.02.2024 compact it 312 (ET: BIBM)]*
    ...
    Answer: Impacts of Air Pollution on Human Health

    Air pollution is now the leading environmental cause of death in Bangladesh. Dhaka is repeatedly ranked among the most polluted cities in the world, with fine particulate levels many times the World Health Organization guideline.

    The main pollutants are PM2.5 and PM10 from brick kilns, vehicle exhaust and construction dust, together with sulphur dioxide, nitrogen oxides, carbon monoxide, ozone and lead.

    The health effects are severe. Fine particles penetrate deep into the lungs and enter the bloodstream, causing asthma, chronic bronchitis, emphysema and lung cancer. They inflame blood vessels and raise the risk of heart attack and stroke. Carbon monoxide reduces the oxygen carried by the blood, producing headache, fatigue and impaired judgement. Lead damages the developing brain and permanently lowers the intelligence of children. Pregnant women exposed to polluted air are more likely to deliver underweight or premature babies. Recent research also links long-term exposure to dementia and depression.

    Children, the elderly, traffic police, rickshaw pullers and street vendors suffer most because they breathe the worst air for the longest time.

    Cleaner brick technology, stricter vehicle emission testing, covered construction sites and expanded urban greenery are urgent, because every year of delay costs thousands of lives.
...
13. **Focus Writing in English: The Importance of Digital Literacy in Expanding Cashless Transactions in Bangladesh: Discuss how digital skills influence financial inclusion, the adoption of digital payment systems, and the challenges of building a cashless economy.** *[Bangladesh Bank Senior Officer (IT), Grade-9 (Job ID-25104) 2024 (ET: N/A)]*
    ...
    Answer: The Importance of Digital Literacy in Expanding Cashless Transactions in Bangladesh

    Bangladesh has built an impressive digital payment infrastructure. Mobile financial services carry crores of taka daily, agent banking has reached the union level, and Bangladesh Bank has introduced RTGS, BEFTN, the National Payment Switch and the interoperable Binimoy platform. Yet cash still dominates. The missing element is not technology but digital literacy.

    How digital skills influence financial inclusion: A person who cannot read a transaction confirmation, set a PIN or recognise a fraudulent call will not trust a digital wallet with savings. Millions of accounts remain dormant for exactly this reason. Basic literacy in using a keypad, understanding charges and reading a statement converts an account holder into an active user.

    Adoption of digital payment systems: Merchants adopt QR codes and card terminals only when they can reconcile the money themselves. Farmers, garment workers and small traders accept digital wages when they can withdraw and transfer without depending on an agent who may cheat them. Skill removes that dependence.

    Challenges of building a cashless economy: Low awareness among rural and elderly users, weak network coverage, high transaction cost for small amounts, fear of fraud after well-publicised scams, the habit of cash in an informal economy, and the exclusion of people without smartphones or national identity documents.

    The way forward is a national digital financial literacy campaign delivered through schools, union digital centres, employers and the agents themselves, combined with simple interfaces in Bangla, strong consumer protection and visible redress when fraud occurs.

    Infrastructure makes cashless payment possible; literacy makes it happen.
14. **The role of ICT in education sector** *[Sonali & Janata Bank Officer (IT) 14.10.2023 compact it 529 (ET: MIST)]*


    Answer: The Role of ICT in the Education Sector

    Information and communication technology has changed education from a one-way transfer of notes into an interactive process of discovery.

    In the classroom, multimedia content, animation and simulation make difficult concepts visible. A biology student can watch cell division; a physics student can vary the parameters of an experiment that no school laboratory could safely perform.

    In access, ICT removes distance. Online courses, digital libraries, recorded lectures and open educational resources let a student in a remote upazila learn from the same material as one in the capital. During the COVID-19 pandemic, this capability kept the education system from collapsing.

    In assessment, computerised testing gives immediate feedback and impartial marking, and learning analytics identify a weak student early enough for the teacher to intervene.

    In administration, digital admission, result publication, attendance monitoring and record keeping have reduced delay, cost and manipulation.

    For teachers, online training platforms and content-sharing portals build professional capacity continuously rather than once in a career.

    The limitations are the digital divide, the cost of devices and connectivity, insufficient teacher training, a shortage of quality local-language content, and the distraction that unsupervised devices bring.

    ICT is therefore best understood as a powerful amplifier: it multiplies the effect of good teaching, but it cannot substitute for it.
15. **Write an essay on 'Women's Empowerment and Gender Equality in Bangladesh' within 200 (+/- 10%) words.** *[Rupali Bank Ltd. Assistant Network Engineer 04.11.2023 compact it 530 (ET: MIST)]*
    ...
    Answer: Women's Empowerment and Gender Equality in Bangladesh

    Women's empowerment means giving women real control over their own lives through education, income, health, mobility and a voice in decisions. Gender equality means that rights and opportunities do not depend on whether a person is born male or female.

    Bangladesh has made progress that is recognised internationally. Gender parity has been achieved in primary and secondary school enrolment. The female stipend programme kept millions of girls in school. About four million women, roughly sixty per cent of the workforce, are employed in the ready-made garment industry, and their earnings have transformed rural households. Microcredit brought credit to women who had never entered a bank. Maternal mortality has fallen sharply, and the total fertility rate has come down to close to replacement level. Women now serve as judges, secretaries, pilots, army officers and entrepreneurs, and reserved seats guarantee their presence in Parliament and in local government.

    Serious problems persist. Child marriage remains among the highest in the world. Dowry demands, domestic violence, sexual harassment and cyber harassment continue. Women's participation in the paid labour force is still only about thirty-seven per cent, they earn less than men for the same work, they carry almost all unpaid household labour, and they are poorly represented in senior management and in the ownership of land.

    The remedies are strict enforcement of existing laws, safe transport and workplaces, affordable childcare, legal literacy, and above all a change in social attitude that begins inside the family.

    No country can advance while half of its people are held back.
16. **Essay on "Digital Financial Literacy"** *[Combined Bank Assistant Programmer 09.06.2023 compact it 497 (ET: N/A)]*


    Answer: Digital Financial Literacy

    Digital financial literacy is the ability to use digital financial services safely, confidently and to one's own advantage. It combines two skills: understanding money, and understanding the technology that now carries it.

    It has four components. The first is knowledge of the products available, such as mobile financial services, internet banking, cards, QR payments and digital savings. The second is practical skill in using them, from registering an account to reading a statement and reversing a wrong entry. The third is awareness of risk, including phishing, fake customer-care calls, OTP fraud, SIM replacement fraud and unlicensed lending applications. The fourth is knowledge of rights, particularly where and how to complain when money is lost.

    Its importance for Bangladesh is direct. The country now has more than twenty crore registered mobile financial service accounts, but a large share are dormant or are operated by an agent on the customer's behalf, which defeats the purpose. Wage payments, social safety-net allowances, remittances and merchant payments are all moving to digital channels, and a user who cannot verify a transaction is exposed to loss and to exploitation.

    Building it requires coordinated action: financial education in the school curriculum, campaigns in Bangla through television and social media, training at union digital centres, simple interfaces designed for first-time users, and clear consumer protection rules enforced by the central bank.
...
1. **Answer the following questions.** *[Assistant Programmer - Department of Immigration & Passports 15.07.2026 compact it 1463 (ET: N/A)], [ENGLISH, Subject Code: 102, Marks: 40 - Passport Office Assistant Programmer 2024 (ET: N/A)]*
...
1. **Read the passage and answer the questions that follow:** *[Assistant Programmer - Department of Immigration & Passports 15.07.2026 compact it 1463 (ET: N/A)], [ENGLISH, Subject Code: 102, Marks: 40 - Passport Office Assistant Programmer 2024 (ET: N/A)]*
