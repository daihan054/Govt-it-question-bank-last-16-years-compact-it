...
| 3 | Network | Logical addressing and routing between networks.<br><br>**Packet structure:**<br>`[ Source IP₁ │ Segment │ Destination IP₂ ]` | Packet | IP, ICMP, OSPF |
| 2 | Data Link | Node-to-node delivery, framing, MAC addressing, error detection.<br><br>**Frame structure:**<br>`[ MAC₁ │ Packet (IP₁ │ Segment │ IP₂) │ MAC₂ ]` | Frame | Ethernet, PPP, ARP |
