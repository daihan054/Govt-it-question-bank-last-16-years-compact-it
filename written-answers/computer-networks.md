...
| 2 | Data Link | Node-to-node delivery, framing, MAC addressing, error detection.<br><br>**Frame structure:**<br>`[ Frame Header (MAC) │ IP Packet (Data) │ Trailer (CRC/FCS) ]` | Frame | Ethernet, PPP, ARP |
