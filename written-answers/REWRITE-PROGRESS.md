...
- [x] algorithm.md — Graph Algorithms (Shortest Path & Minimum Spanning Tree) (14)
- [x] algorithm.md — Algorithm Analysis & Asymptotic Complexity (12)
- [x] algorithm.md — Searching Algorithms (11)
- [x] algorithm.md — Dynamic Programming & Greedy Algorithms (7)
...
- [x] algorithm.md — Graph Representation (Adjacency Matrix vs List) (2)
- [x] algorithm.md — Divide and Conquer & Matrix Multiplication (1)
- [x] algorithm.md — Huffman Coding & Data Compression (1)
...
- [x] cloud-computing.md — Cloud Service Models (12)
...
- [x] cloud-computing.md — Cloud Security & Compliance (1)
...
- [x] computer-network-security.md — Social Engineering & Cyber Attacks (26)
- [x] computer-network-security.md — Firewalls & Network Defense (16)
- [x] computer-network-security.md — Authentication & Access Control (15)
- [x] computer-network-security.md — Web Security Vulnerabilities (15)
- [x] computer-network-security.md — Malware & Security Threats (15)
- [x] computer-network-security.md — Security Protocols (SSL/TLS, HTTPS) (11)
...
- [x] computer-network-security.md — Email & Messaging Security (Spam, Phishing) (2)
- [x] computer-network-security.md — Buffer Overflow & Software Vulnerabilities (1)
...
- [x] computer-networks.md — Networking Fundamentals & Terminology (23)
- [x] computer-networks.md — Application Layer Protocols & Troubleshooting (DNS, DHCP, HTTPS) (19)
- [x] computer-networks.md — Multiplexing & Bandwidth (18)
- [x] computer-networks.md — Routing Protocols & Route Configuration (18)
- [x] computer-networks.md — Wireless Networks & IoT (mmWave) (17)
- [x] computer-networks.md — Transport Layer (TCP & UDP) (15)
- [x] computer-networks.md — Networking Devices (14)
- [x] computer-networks.md — Communication System & Transmission Modes (14)
- [x] computer-networks.md — Physical Layer & Transmission Media (Cables & Wiring) (14)
- [x] computer-networks.md — Error Detection & Data Communication (CRC, Throughput) (14)
- [x] computer-networks.md — Data Rate & Channel Capacity (Nyquist, Shannon) (14)
- [x] computer-networks.md — Network Topologies (12)
- [x] computer-networks.md — IPv6 Addressing (11)
- [x] computer-networks.md — Physical Layer & Optical Fiber (Attenuation & Power Budget) (11)
- [x] computer-networks.md — Network Address Translation (NAT) (11)
- [x] computer-networks.md — Network Services (DHCP, NAT) (10)
- [x] computer-networks.md — Digital Modulation & Signal Processing (BPSK, QPSK) (10)
- [x] computer-networks.md — Flow Control & Data Link Layer (Stop-and-Wait) (9)
- [x] computer-networks.md — Email Architecture & Protocols (SMTP, POP3, IMAP) (9)
- [x] computer-networks.md — Application Layer & Well-Known Port Numbers (6)
- [x] computer-networks.md — Switching Techniques (Circuit vs Packet Switching) (5)
- [x] computer-networks.md — WAN Technologies (SONET/SDH, ATM, WDM) (5)
- [x] computer-networks.md — Pulse Code Modulation (PCM) & Signal Processing (4)
- [x] computer-networks.md — Network Layer (Packet Fragmentation & Tunneling) (4)
- [x] computer-networks.md — Analog Modulation & Radio Receivers (3)
- [x] computer-networks.md — Satellite Communication (3)
- [x] computer-networks.md — Line Coding & Digital Encoding (2)
- [x] computer-networks.md — Address Resolution (ARP & RARP) (2)
- [x] computer-networks.md — VLANs & Subnetting Comparison (2)
- [x] computer-networks.md — Spread Spectrum & Multiple Access (CDMA, FHSS, DSSS) (2)
- [x] computer-networks.md — High Availability & Redundancy Protocols (VRRP, HSRP) (1)

## data-structure.md — 8 sections
- [x] data-structure.md — Tree (26)
- [x] data-structure.md — Stack (19)
- [x] data-structure.md — Linked List (14)
- [x] data-structure.md — Priority Queues & Heaps (Min/Max Heap) (7)
- [x] data-structure.md — Queue (6)
- [x] data-structure.md — Binary Search Tree (BST) (6)
- [x] data-structure.md — Hashing & Hash Tables (6)
- [x] data-structure.md — Data Structure Fundamentals (2)

## database.md — 19 sections
- [x] database.md — SQL Queries (71)
- [x] database.md — DBMS Architecture & Features (22)
- [x] database.md — ER Diagram & Database Design (21)
- [x] database.md — Keys in DBMS (21)
- [x] database.md — Normalization & Database Design (18)
- [x] database.md — SQL Commands (DDL, DML, DCL, TCL) (13)
- [x] database.md — Transaction Management & ACID Properties (12)
- [x] database.md — Relational Data Model & ER Relationships (11)
- [x] database.md — Database Backup & Disaster Recovery (8)
...
- [x] database.md — Database Connectivity (JDBC) (2)
- [x] database.md — Relational Keys (Candidate, Super, Primary, Foreign Key) (1)
- [x] database.md — Indexing in DBMS (1)

## dld.md — 9 sections
- [x] dld.md — Logic Gates & Universal Gates (27)
- [x] dld.md — Number Systems & Base Conversions (19)
- [x] dld.md — Combinational Circuits (Adders, Encoders, MUX) (18)
...
- [x] oop.md — Constructors & Destructors (5)
- [x] oop.md — Output Tracing & Recursion (3)
- [x] oop.md — Exception Handling (3)
- [x] oop.md — C++ OOP Concepts & Friend Functions (2)
...
- [x] software-engineering.md — SDLC Phases & Models (37)
