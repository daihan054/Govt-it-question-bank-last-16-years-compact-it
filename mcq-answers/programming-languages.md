...
1. **To start Python from the command prompt, use the command _____** *[Combined Bank Senior Officer (IT) 17.05.2024 compact it 7 (ET: BIBM)]*
   a) execute python
   b) go python
   c) python
   d) run python
...
1. **What is the API level of Android version 11?** *[Sonali Bank and BDBL Senior Officer (IT) 25.09.2021 compact it 101 (ET: N/A)]*
   (a) 24
   (b) 25
   (c) 31
   (d) None of the above
...
1. **.NET can be used in the following-** *[Sonali Bank and BDBL Senior Officer (IT) 25.09.2021 compact it 101 (ET: N/A)]*
