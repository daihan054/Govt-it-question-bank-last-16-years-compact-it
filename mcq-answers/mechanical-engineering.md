...
1. **Moment of Inertia এর একক হলো-** *[BPSC Senior Instructor (MEW) 2021 compact it 142 (ET: N/A)]*
   (ক) \text{mm}^4
   (খ) \text{mm}^3
   (গ) \text{mm}^2
   (ঘ) \text{mm}^5
...
1. **গিয়ার তৈরিতে সাধারণত ব্যবহৃত হয়-** *[BPSC Senior Instructor (MEW) 2021 compact it 142 (ET: N/A)]*
   (ক) Cast Iron
   (খ) Steel
   (গ) Copper
   (ঘ) Wrought Iron
...
1. **ডিলিং মেসিন কর্তৃক কোন অপারেশন সম্পন্ন করা হয়-** *[BPSC Senior Instructor (MEW) 2021 compact it 142 (ET: N/A)]*
   (ক) Spot facing
   (খ) Reaming
   (গ) Boring
   (ঘ) সবকটি
...
1. **Motion study chart I Therbligs symbol হল-** *[BPSC Senior Instructor (MEW) 2021 compact it 144 (ET: N/A)]*
   (ক) ২১টি
   (খ) ১৭টি
   (গ) ১৮টি
   (ঘ) ১৫টি
...
1. **কোন Technical drawing এর ক্ষেত্রে উর্ধ্বরিহম এ দৈর্ঘ্য ও বস্তুর প্রকৃত দৈর্ঘ্যের অনুপাতকে বলে-** *[BPSC Senior Instructor (MEW) 2021 compact it 142 (ET: N/A)]*
...
1. **স্থির তরলের ক্ষেত্রে শেয়ার পীড়ন হল:** *[BPSC Senior Instructor (MEW) 2021 compact it 145 (ET: N/A)]*
   ...
   (ঘ) কোনটি নয়।
answer: B
explanation: স্থির তরলে (Static fluid) কোনো আপেক্ষিক গতি বা বেগ নতিমাত্রা (velocity gradient) থাকে না, ফলে কোনো শিয়ার পীড়ন (Shear Stress) থাকে না অর্থাৎ স্থির অবস্থায় তা শূন্য হয়।
