...
2. **What is the synonym of 'bona fide'?** **(PGCB Assistant Engineer (CSE) Exam: 05.04.2024 (BUET)) [compact it 4]**
   ক. Cheat
   খ. Authentic
   গ. Contaminate
   ঘ. Adulterate

3. **The word 'precedence' means.** **(PGCB Assistant Engineer (CSE) Exam: 05.04.2024 (BUET)) [compact it 5]**
   ক. example
   খ. priority
   গ. importance
   ঘ. none
