...
```mermaid
flowchart TD
    A["① INTRODUCTION — 2 to 3 sentences<br/>Define the topic · state why it matters ·<br/>give the essay's THESIS"] --> B["② BODY PARAGRAPH 1<br/>The first main idea<br/>+ explanation + EXAMPLE"]
    B --> C["③ BODY PARAGRAPH 2<br/>The second main idea<br/>+ explanation + DATA / FACT"]
    C --> D["④ BODY PARAGRAPH 3<br/>Challenges / the other side /<br/>the Bangladesh context"]
    D --> E["⑤ CONCLUSION — 2 to 3 sentences<br/>Summarise · give a RECOMMENDATION ·<br/>end on a forward-looking note"]
```
...
- [Translate into English: "আমি কাজটি অবশ্যই করায় নিব।"](../written-answers/english.md?plain=1#L754)
