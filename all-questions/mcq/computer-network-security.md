...
1. **Which algorithm is used in email security?** *[Bangladesh Bank Assistant Director (ICT) 07.02.2025 compact it xix (ET: DU)]*
   (a) AES
   (b) RSA
   (c) SHA
   (d) All of the above
...
1. **Which of the items listed below is the least strong security protocol?** *[Combined Bank Officer (IT) 04.10.2024 compact it 14 (ET: BIBM)]*
   (a) SFTP
   (b) SMTP
   (c) SSL
   (d) HTTP
...
1. **How can we prevent SQL Injection Attack?** *[Sonali, Janata & Rupali Bank Ltd. Senior Officer (AHE) / AE (IT)/ AME 25.10.2021 compact it 131 (ET: N/A)]*
   a) Show the database error to the users
...
1. **What kind of encryption is used for securing emails in transit?** *[Bangladesh Bank Assistant Director (ICT) 07.02.2025 compact it xx (ET: DU)]*
